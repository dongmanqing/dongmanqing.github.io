---
layout: post
title: A quick tour for GLM
description: The base model of ChatGLM
tags: LLMs, paper-reading
categories: paper-reading
thumbnail: assets/img/posts/quick-GLM/chatglm.jpg  # thumbnail is the graph loaded on the display page
...
- Autoencoding models (e.g., BERT): which are generally used for NLU tasks.
- Autoregressive models (e.g., GPT): which are used for unconditional text generation.
- Encoder-decoder models (e.g., T5): which are used for conditional text generation.
