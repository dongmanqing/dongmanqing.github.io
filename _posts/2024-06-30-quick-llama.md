---
layout: post
title: A quick tour for LLaMA
description: An open source model from Meta
tags: LLMs, paper-reading
categories: paper-reading
thumbnail: assets/img/posts/quick-llama/llama.jpg  # thumbnail is the graph loaded on the display page
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/posts/quick-GLM/example_transformers.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
